...
- На сенсорных экранах внизу — три экранные кнопки: слева пара **← →** (зажать = непрерывное движение), справа **↑** (тап = прыжок, второй тап = двойной прыжок)
...
- [x] Уровень из платформ и земли, шесть ям и девять навесных платформ
...
- [x] **Раунд 30 секунд** — счёт = количество собранных монет за раунд
...
- [x] KillZone под уровнем — падение в яму = немедленный конец раунда (раунд фиксируется в лидерборде)
...
├── Gameplay/
│   ├── PlayerController.cs   ← движение, прыжок, ground-check, Freeze
